    ...
    <div
      ...
      style={{
        backgroundImage: `
          ...
          linear-gradient(120deg,#fff6e8 0%,#ffe4ec 25%,#e6f2ff 50%,#ffe8f3 75%,#fff6e8 100%)
        `,
      }}
    >
      <motion.div
      ...
      >
        {/* แทน Card ด้วย div */}
        <div className="rounded-3xl shadow-2xl border border-white/40 bg-white/90 backdrop-blur-xl p-8 md:p-12 text-center space-y-8">
          ...
          <div className="grid grid-cols-2 gap-8 text-center">
            ...
            <div className="space-y-3">
              <h2 className={`${greatVibes.className} text-7xl md:text-8xl`}>
                Mew
              </h2>
              <p className={`${playfair.className} text-2xl md:text-3xl`}>
                ดร. เมวดี สร้อยทอง
              </p>
              <div className={`${montserrat.className} text-sm md:text-base text-gray-600 pt-2`}>
          ...
          <Heart className="mx-auto w-6 h-6 text-rose-400" />
          ...
          <div className="pt-6 border-t space-y-3">
            ...
            <div className={`${montserrat.className} space-y-1 text-sm md:text-base`}>
